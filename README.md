...
> **Journey:** [Data setup](docs/data_setup.md) → [UDF setup](docs/udf-setup.md) → [App deployment](docs/app-guide.md) → [Authorization](docs/auth.md)
...
Complete [Data setup](docs/data_setup.md) first, then follow [UDF setup](docs/udf-setup.md) → [App deployment](docs/app-guide.md) → [Authorization](docs/auth.md).

1. [Data setup](docs/data_setup.md) owns creation and verification of the four Fabric data inputs.
2. [UDF setup](docs/udf-setup.md) owns the UDF primer, architecture, four UDF creation flows, publication, portal verification, and application configuration.
3. [App deployment](docs/app-guide.md) owns Azure Maps creation, App Service creation, portal deployment, application configuration, and hosted verification.
4. [Authorization](docs/auth.md) owns every identity, tenant setting, permission, role, scope, token audience, and authorization troubleshooting step.
